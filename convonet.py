...
class DeepONet:
    ...
    def __init__(self,
        ...
        funct = keras.layers.Input((m, dim_f), name='funct')
        ...
        # Branch network
        hid_b = keras.layers.Conv1D(filters=5,
                                    kernel_size=3,
                                    padding='same',
                                    activation=self.act_fn,
                                    input_shape=[m, dim_f],
                                    )(hid_b)
        hid_b = keras.layers.MaxPooling1D(pool_size=2,
                                          padding='same')(hid_b)
        hid_b = keras.layers.Flatten()(hid_b)
